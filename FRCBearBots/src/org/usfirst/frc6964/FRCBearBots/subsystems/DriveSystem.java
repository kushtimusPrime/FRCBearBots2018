...
public class DriveSystem extends Subsystem {
    ...
    DifferentialDrive robotDrive = RobotMap.driveSystemDifferentialDrive1;
...
//    	robotDrive.arcadeDrive(joystick.getY(), joystick.getX()); //For one
    	robotDrive.tankDrive(leftJoystick.getY(), rightJoystick.getY()); //For two
    }
    
    public void takeJoystickInput(Joystick joystick) {
    	robotDrive.arcadeDrive(joystick.getY()*sensitivity, joystick.getX()*sensitivity);
    }
    
    public void takeXJoystickAxisOnly(Joystick joystick) {
    	robotDrive.arcadeDrive(0, joystick.getX()/2);
    }
    
    public void takeThrottle(Joystick joystick) {
    	sensitivity = joystick.getThrottle();

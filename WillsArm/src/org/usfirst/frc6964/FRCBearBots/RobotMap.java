...
public class RobotMap {
    ...
    public static Compressor armSystemCompressor1;
    public static DoubleSolenoid armSystemDoubleSolenoid1;
    public static SpeedController armSystemSpeedController1;
    ...
    public static void init() {
        ...
        armSystemCompressor1 = new Compressor(0);
        LiveWindow.addActuator("ArmSystem", "Compressor 1", armSystemCompressor1);
        
        armSystemDoubleSolenoid1 = new DoubleSolenoid(0, 0, 1);
        LiveWindow.addActuator("ArmSystem", "Double Solenoid 1", armSystemDoubleSolenoid1);
        
        armSystemSpeedController1 = new PWMVictorSPX(4);
        LiveWindow.addActuator("ArmSystem", "Speed Controller 1", (PWMVictorSPX) armSystemSpeedController1);
        armSystemSpeedController1.setInverted(false);
